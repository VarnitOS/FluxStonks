...
const InfiniteScroll: React.FC<InfiniteScrollProps> = ({
  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden w-full infinite-scroll-wrapper" ref={wrapperRef}>
        <div
          className="relative cursor-grab [transform-style:preserve-3d] [perspective:1000px] infinite-scroll-container"
          ref={containerRef}
          style={{
        ...
        >
          {items.map((item, i) => (
            <div 
              className="absolute w-full [will-change:transform] infinite-scroll-item" 
              key={i}
            >
              {item.content}
            </div>
